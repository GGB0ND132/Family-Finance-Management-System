...
export interface ImportPreviewPayload { family_id: string; scope: 'personal' | 'family'; member_id?: string; account_id: string; file_name: string; file_type: 'CSV' | 'XLSX'; mapping: Record<string, string> }
