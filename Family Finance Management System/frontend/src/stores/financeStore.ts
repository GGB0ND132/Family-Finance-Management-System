...
import { accounts as seedAccounts, categories as seedCategories, familyMembers, initialBudgets, initialTransactions, initialTransfers, type Account, type Category, type CategoryType, type DataScope, type FinanceTransaction, type FinanceTransfer, type MonthlyBudget } from '../data/financeData'
